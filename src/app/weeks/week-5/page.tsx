...
export default function Week5Page() {
  ...
  const handleVideo1TimeUpdate = () => {
    ...
    if (video && video.duration) {
      ...
      if (progress >= 90 && !video1Completed) {
        ...
        localStorage.setItem('week5-video1-completed', 'true');
      }
    }
  };
  ...
  const handleVideo2TimeUpdate = () => {
    ...
    if (video && video.duration) {
      const progress = (video.currentTime / video.duration) * 100;
      if (progress >= 90) {
        localStorage.setItem('week5-video2-completed', 'true');
      }
    }
  };
    ...
    <div className="week-5-page">
      ...
      <main>
        ...
        <section className="exercise-section-main">
          ...
          <div className="exercise-content-wrapper">
            <div className="exercise-intro-text">
              <h3 className="exercise-number"><strong>Exercise 10: Deep Breathing & Relaxation Mastery</strong></h3>
              ...
              <div className="video-thumbnail-wrapper">
                {!week5Unlocked && (
                  <>
                    ...
                    <p className="lock-message">Complete Week 4 to unlock</p>
                  </>
                )}
                <video 
                  ref={video1Ref}
                ...
                >
                  <source src="/assets/videos/session 5 - excercise 15 final.mp4" type="video/mp4" />
        ...
        <section className="exercise-section-main">
          ...
          <div className="exercise-content-wrapper">
            <div className="exercise-intro-text">
              <h3 className="exercise-number"><strong>Exercise 11: Straw Phonation - Stage 4</strong></h3>
              <p className="exercise-description">
            ...
            <div className="video-section-container">
              <div className="video-thumbnail-wrapper locked-state">
                ...
                >
                  <source src="/assets/videos/session 5 - excercise 16 final.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
